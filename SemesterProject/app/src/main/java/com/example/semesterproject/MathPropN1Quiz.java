...
public class MathPropN1Quiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_prop_n1_quiz);
        ...
        if(savedInstanceState==null){
            QuizDbHelperPropN1 dbHelper=new QuizDbHelperPropN1(this);
            ...
            public void onClick(View v) {
                if(!answered){
                    if(rb1.isChecked()|| rb2.isChecked() || rb3.isChecked() || rb4.isChecked()){
                        ...
                        Toast.makeText(MathPropN1Quiz.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else{
                    showNextQuestion();
                }
