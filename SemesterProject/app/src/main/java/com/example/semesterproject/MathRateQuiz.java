...
public class MathRateQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_rate_quiz);
        ...
        if(savedInstanceState==null){
            QuizDbHelperRate dbHelperRate=new QuizDbHelperRate(this);
            questionList= dbHelperRate.getAllQuestions();
            ...
            public void onClick(View v) {
                if(!answered){
                    if(rb1.isChecked()|| rb2.isChecked() || rb3.isChecked() || rb4.isChecked()){
                        ...
                        Toast.makeText(MathRateQuiz.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else{
                    showNextQuestion();
                }
