...
public class MathPropN3Quiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_prop_n3_quiz);
        ...
        if(savedInstanceState==null){
            QuizDbHelperPropN3 dbHelper=new QuizDbHelperPropN3(this);
            ...
            public void onClick(View v) {
                if(!answered){
                    if(rb1.isChecked()|| rb2.isChecked() || rb3.isChecked() || rb4.isChecked()){
                        ...
                        Toast.makeText(MathPropN3Quiz.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else{
                    showNextQuestion();
                }
