...
public class MathNNQuiz2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_n_n_quiz2);
        ...
        if(savedInstanceState==null){
            QuizDbHelperNN2 dbHelper=new QuizDbHelperNN2(this);
            ...
            public void onClick(View v) {
                if(!answered){
                    if(rb1.isChecked()|| rb2.isChecked() || rb3.isChecked() || rb4.isChecked()){
                        ...
                        Toast.makeText(MathNNQuiz2.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else{
                    showNextQuestion();
                }
