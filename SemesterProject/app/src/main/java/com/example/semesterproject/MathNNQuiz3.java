...
public class MathNNQuiz3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_n_n_quiz3);
        ...
        if(savedInstanceState==null){
            QuizDbHelperNN3 dbHelper=new QuizDbHelperNN3(this);
            ...
            public void onClick(View v) {
                if(!answered){
                    if(rb1.isChecked()|| rb2.isChecked() || rb3.isChecked() || rb4.isChecked()){
                        ...
                        Toast.makeText(MathNNQuiz3.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else{
                    showNextQuestion();
                }
